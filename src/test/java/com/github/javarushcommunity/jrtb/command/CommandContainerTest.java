...
public class CommandContainerTest {
    ...
    public void init(){
        ...
        commandContainer = new CommandContainer(sendBotMessageService, telegramUserService,javaRushGroupClient,groupSubService, singletonList("username"), statisticsService);
    }
